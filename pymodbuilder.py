...
regex_commands.insert(-2, lambda name: regex_copy(name,'_regex.c') )
regex_commands.insert(-2, lambda name: regex_copy(name,'_regex.h') )
regex_commands.insert(-2, lambda name: regex_copy(name,'_regex_unicode.c') )
regex_commands.insert(-2, lambda name: regex_copy(name,'_regex_unicode.h') )
regex_commands.insert(-2,'python PyPI\setup.py bdist_wininst')
